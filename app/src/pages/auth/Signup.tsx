        ...
        <Card className="bg-[#111] border-white/10 shadow-2xl rounded-3xl overflow-hidden backdrop-blur-xl">
          ...
          <CardContent className="pt-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-3">
                <Label className="text-gray-300 font-semibold uppercase tracking-wider text-xs">I want to join as</Label>
                <RadioGroup
                  value={role}
              ...
              <div className="space-y-2">
                <Label htmlFor="name" className="text-gray-300">Full Name <span className="text-red-500">*</span></Label>
                <Input
                  id="name"
          ...
          <CardFooter className="flex justify-center border-t border-white/5 bg-white/[0.02] py-4">
            <p className="text-sm text-gray-400">
              ...
              <Link to="/login" className={`font-semibold ${role === 'client' ? 'text-purple-400 hover:text-purple-300' : 'text-rose-400 hover:text-rose-300'}`}>
                Sign in
              </Link>
            </p>
          </CardFooter>
